...
import { ChevronLeft, ChevronRight, X, Pencil, Camera, Trash2 } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-4xl p-0 gap-0 overflow-hidden max-h-[90vh] flex flex-col">
        ...
        {/* Image area */}
        <div className="relative bg-black min-h-[40vh] sm:min-h-[50vh] flex-1 flex items-center justify-center">
          {photoUrl && !imageError ? (
            <Image
              src={photoUrl}
              alt={item.name}
